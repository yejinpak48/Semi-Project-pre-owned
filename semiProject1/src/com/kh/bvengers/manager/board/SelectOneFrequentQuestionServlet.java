...
/**
 * Servlet implementation class SelectOneFrequentQuestionServlet
 */
@WebServlet("/sofq.mm")
public class SelectOneFrequentQuestionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectOneFrequentQuestionServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(hmap != null) {
			...
			page = "views/manager/board/FrequentDetail.jsp";
